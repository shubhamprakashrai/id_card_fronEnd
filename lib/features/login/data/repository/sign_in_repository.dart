...
class SignInRepository extends SignInBaseRepositoty{
  ...
  const SignInRepository(this.apiClient);
  ...
  Future<SignupResponseModel> userSign(SignInRequestModel signInRequestModel) async {
   ...
   try {
      ...
      await HiveStorage.instance.savedToken(signInResponsce.token);
      await HiveStorage.instance.saveUser(signInResponsce.user);
